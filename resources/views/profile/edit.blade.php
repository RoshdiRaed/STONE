                ...
                <div class="max-w-xl">
                    ...
                    <div class="mt-4">
                        @if (Auth::user()->profile_picture)
                            <img src="{{ asset('storage/' . Auth::user()->profile_picture) }}" alt="Profile Picture" class="w-32 h-32 rounded-full">
                        @else
                    ...
                    <div class="mt-4">
                        @if (Auth::user()->resume)
                            <a href="{{ asset('storage/' . Auth::user()->resume) }}" target="_blank" class="text-blue-600 dark:text-blue-400 hover:underline">Download Resume</a>
                        @else
