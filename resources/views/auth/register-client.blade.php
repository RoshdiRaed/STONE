...
<div class="max-w-md mx-auto mt-12 p-6 bg-[#2F3241] shadow-lg rounded-lg mt-56 mb-56">
    ...
    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
        ...
        <div class="mb-4">
            ...
            <x-text-input id="company_name" class="form-input block mt-1" type="text" name="company_name" placeholder="Your Company Name" />
        ...
        <div class="mb-4">
            ...
            <x-text-input id="position" class="form-input block mt-1" type="text" name="position" placeholder="Your Position" />
